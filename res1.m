...
[GOC_depth, GOC_pressure, GOC_comp, info] = detect_GOC(comp_ref, press_ref, temp,h_ref, depth_range_goc, Pc, Tc, acentric, BIP, M_gmol, 1, vt_params);
...
[comp_at_goc, P_at_goc, ~, ~] = main(GOC_depth, h_ref, comp_ref, press_ref, temp, ...
    Pc, Tc, acentric, BIP, M_gmol, 1, vt_params);
...
[~, ~, H_ig_spec, H_res_spec, H_abs_spec] = calculate_absolute_enthalpy(temp, press_ref, comp_ref, Pc, Tc, acentric, BIP, M_gmol, Cp_coeffs, H_ig_ref);
...
[~, H_mix_ref , H_ig_spec, H_res_spec, H_abs_spec] = calculate_absolute_enthalpy(temp, press_ref, comp_ref, Pc, Tc, acentric, BIP, M_gmol, Cp_coeffs, H_ig_ref);
R = 8.314462618;
H_ig_plot = H_ig_spec  / R;
H_res_plot = H_res_spec / R;
H_tot_plot = H_abs_spec  / R;
