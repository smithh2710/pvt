...
%   zfactor    - compressibility factor (minimum root for liquid)
% -------------------------------------------------------------------------

function [fugcoef, zfactor] = fugacitycoef_multicomp_liquid(comp, press, temp, pressc, tempc, acentric, BIP, eos_type, components)
